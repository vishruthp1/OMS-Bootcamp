 ...
 */
package com.vishruth.order_service.event;
...
public class OrderCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = 7601639464800426329L;


    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderCreatedEvent\",\"namespace\":\"com.vishruth.order_service.event\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"productName\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"double\"},{\"name\":\"createdAt\",\"type\":\"string\"}]}");
     ...
     */
    public OrderCreatedEvent(java.lang.CharSequence orderId, java.lang.CharSequence productName, java.lang.Integer quantity, java.lang.Double price, java.lang.CharSequence createdAt) {
     ...
     */
    public static com.vishruth.order_service.event.OrderCreatedEvent.Builder newBuilder() {
        return new com.vishruth.order_service.event.OrderCreatedEvent.Builder();
    }
     ...
     * @return A new OrderCreatedEvent RecordBuilder
     */
    public static com.vishruth.order_service.event.OrderCreatedEvent.Builder newBuilder(com.vishruth.order_service.event.OrderCreatedEvent.Builder other) {
        if (other == null) {
            return new com.vishruth.order_service.event.OrderCreatedEvent.Builder();
        } else {
            return new com.vishruth.order_service.event.OrderCreatedEvent.Builder(other);
        }
    }
     ...
     * @return A new OrderCreatedEvent RecordBuilder
     */
    public static com.vishruth.order_service.event.OrderCreatedEvent.Builder newBuilder(com.vishruth.order_service.event.OrderCreatedEvent other) {
        if (other == null) {
            return new com.vishruth.order_service.event.OrderCreatedEvent.Builder();
        } else {
            return new com.vishruth.order_service.event.OrderCreatedEvent.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCreatedEvent>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(com.vishruth.order_service.event.OrderCreatedEvent.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(com.vishruth.order_service.event.OrderCreatedEvent other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.orderId)) {
                this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder setOrderId(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder clearOrderId() {
            orderId = null;
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder setProductName(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder clearProductName() {
            productName = null;
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder setQuantity(int value) {
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder clearQuantity() {
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder setPrice(double value) {
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder clearPrice() {
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder setCreatedAt(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public com.vishruth.order_service.event.OrderCreatedEvent.Builder clearCreatedAt() {
            createdAt = null;
